...
// BorderType defines the style of the border (single, double, rounded, etc.)
type BorderType int
...
// BorderStyles allows specifying a different Style for each border side
...
// Style represents the style of one terminal cell or border
type Style struct {
	Fg       Color
	Bg       Color
	Modifier Modifier
